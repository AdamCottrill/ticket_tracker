...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FollowUp.action'
        db.add_column(u'tickets_followup', 'action',
                      self.gf('django.db.models.fields.CharField')(default='no_action', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FollowUp.action'
        db.delete_column(u'tickets_followup', 'action')
